  ...
  <section class="idxWod">
    <div class="contentWrap">
      <div class="idxSecTit" v-reveal>
        <span class="idxSecEyebrow">TODAY'S WOD</span>
        <h2>오늘의 운동</h2>
        <p>매일 갱신되는 오늘의 WOD와 회원들의 운동기록을 확인하세요.</p>
      </div>
      <div class="idxWodGrid">
        <div class="idxWodCard" v-reveal>
          <span class="idxWodDate">TODO: 오늘 날짜 자동 표기 필요</span>
          <h3>WOD 미리보기</h3>
          <ul>
          ...
          <a href="/wod" class="idxHeroBtn isGhost">오늘의 WOD 전체보기</a>
        </div>
        <div class="idxWodLogCard idxScheduleCard" v-reveal>
          <h3>크로스핏 핌 시간표</h3>
          <div class="scheduleGroup">
            ...
            <ul class="scheduleList">
              ...
              <li><span class="scheduleTime">22:30–23:30</span><span class="scheduleBadge isOpen">개인 운동시간</span></li>
            </ul>
          </div>
          <div class="scheduleGroup">
            <h4>토요일</h4>
